...
const handleDeleteLastRitardo = async () => {
 ...
 <div className="bg-gray-100 shadow-lg rounded-lg border-2 border-blue-400 w-full max-w-[98%] md:max-w-[1200px] mx-auto min-h-0 h-auto md:h-[780px] p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-4 mt-4">
          ...
          <div className="w-full space-y-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow-md">
              <AulePrenotazione type="calendar" selectedDate={selectedDate} onDateChange={setSelectedDate} />
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md">
              <AulePrenotazione type="form" selectedDate={selectedDate} onDateChange={setSelectedDate} />
            </div>
          </div>
          ...
          <div className="w-full space-y-4">
            {/* Lista Aule */}
            <div className="bg-white p-4 rounded-lg shadow-md">
              <AulePrenotazione type="list" selectedDate={selectedDate} onDateChange={setSelectedDate} />
            </div>
          </div>
          {/* Fine Colonna Destra */}
        </div>
